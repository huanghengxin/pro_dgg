...
** -->
  ...
  <div class="tinymce">
    <editor v-model="content" class="spTinymce" :init="init"></editor>
  </div>
</template>
<script>
...
import 'tinymce/plugins/hr'; //hr 水平分割线
...
export default {
  ...
  props: {
    ...
    toolbar: {
      type: [String, Array],
      default: () => {
        return [' bold  italic hr| image| alignright aligncenter alignleft|  redo undo'];
      },
    },
    // toolbar 超出展示方式
    toolbarMode: {
  ...
  data() {
    // 'https://sp-img-wlh.oss-cn-beijing.aliyuncs.com/sp-pt/wap/files/tinymce/skins/ui/default/skin.min.css'
    return {
      tinymceIndex: 1,
      editor: null,
      content: '', // 富文本内容
      init: {
        ...
        auto_focus: true,
        skin_url:
          'https://sp-img-wlh.oss-cn-beijing.aliyuncs.com/sp-pt/wap/files/tinymce/skins/ui/default', // 皮肤包地址
        content_css:
          'https://sp-img-wlh.oss-cn-beijing.aliyuncs.com/sp-pt/wap/files/tinymce/skins/content/default/content.css',
