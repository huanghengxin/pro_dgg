      ...
      <el-main style="width: 1200px; margin: 0 auto">
        <div v-if="!SP_MICRO_FE && isShowMenu" class="el-main_menu">
          <el-menu ref="elMenuRef" :default-active="defaultActive" active-text-color="#4974F5">
            ...
            <el-submenu index="3">
              ...
              <el-menu-item-group>
                ...
                <el-menu-item index="3-6">
                  <router-link to="/harassment-rule" tag="div">防骚扰规则</router-link>
                </el-menu-item>
                <el-menu-item index="3-7">
                  <router-link to="/harassment-client" tag="div">防骚扰客户</router-link>
                </el-menu-item>
              </el-menu-item-group>
            </el-submenu>
            <el-submenu index="4">
            ...
            <el-submenu index="5">
              <template slot="title">薪火计划</template>
              <el-menu-item-group>
                <el-menu-item index="5-1">
                  <router-link to="/torch-plan-allocation" tag="div">薪火计划设置</router-link>
                </el-menu-item>
                <el-menu-item index="5-2">
                  <router-link to="/personal-info" tag="div">人员信息</router-link>
                </el-menu-item>
              </el-menu-item-group>
            </el-submenu>
            ...
            <el-submenu index="6">
              <template slot="title">必懂</template>
              <el-menu-item-group>
                <el-menu-item index="6-1">
                  <router-link to="/answer" tag="div">问题广场</router-link>
                </el-menu-item>
                <el-menu-item index="6-2">
                  <router-link to="/my-answer" tag="div">我的回答</router-link>
                </el-menu-item>
              </el-menu-item-group>
            </el-submenu>
          </el-menu>
      ...
      this.$watch(
        ...
        (val) => {
          ...
          this.isShowMenu = ![
            ...
            '/add-business',
            '/error-list',
            '/must-understand/answer-details',
            '/login',
          ].includes(val.path);
          if (val.path === '/login') {
            this.fallback = false;
