...
import { get_plat_form_user_info_list, page_list, get_detail_page } from 'api/close-black-limit';
// import { get_detail_page } from 'api/torch-plan';
    ...
    labelType() {
      return (people) => {
        if (this.type == 'peopleList') {
          return people[peopleMap[this.type]['name']];
        } else {
