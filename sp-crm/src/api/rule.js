...
// 后台平台规则
export function query_rules(params) {
  return api.post(
    '/crm-middle-pc/api/crisps-crm/service/yk/v1/rule/platform/query_rules.do',
    params,
  );
}
// 后台商户规则
export function merchants_query_rules(params) {
  return api.post(
    '/crm-middle-pc/api/crisps-crm/service/yk/v1/rule/merchants/query_rules.do',
    params,
  );
}
...
// // 合作联盟后台商户规则
export function query_cooperate(params) {
  return api.post(
    '/crm-middle-pc/api/crisps-crm/service/yk/v1/rule/platform/query_cooperate.do',
    params,
  );
}
