...
import { curentAppUrl } from '@/config';
import Vue from 'vue';
Vue.use(BaiduMap, {
...
export default {
  ...
  methods: {
    ...
    saveMap() {
      this.keyword = '';
      let iframeUrl = `${curentAppUrl}/#/bdMap/?lng=${this.center.lng}&lat=${this.center.lat}&zoom=${this.zoom}&positionLng=${this.position.lng}&positionLat=${this.position.lat}`;
