...
export default {
  ...
  props: {
    ...
    plugins: {
      type: String,
      default:
        'code link lists image table fullscreen media preview charmap print hr pagebreak save emoticons paste',
    },
    // 富文本工具栏配置
    toolbar: {
      type: [String, Array],
      default: () => {
        return [
          ...
          'alignright aligncenter alignleft | link unlink | emoticons image  media  | hr pagebreak print preview charmap', // bdMap
        ];
      },
    },
    // toolbar 超出展示方式
  ...
  data() {
    return {
      ...
      init: {
        ...
        content_css: `https://sp-img-wlh.oss-cn-beijing.aliyuncs.com/sp-pt/wap/files/tinymce/skins/content/default/content.css`,
