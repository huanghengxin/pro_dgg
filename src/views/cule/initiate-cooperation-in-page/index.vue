  ...
  <div v-loading="loading" class="add-business-page">
    ...
    >
      ...
      <el-form-item label="合作类型：" prop="cooperationType">
        <el-select
          v-model="ruleForm.cooperationType"
      ...
      >
        <el-select
          v-model="ruleForm.cooperationAcceptor"
      ...
      <el-form-item v-else label="抢单人员范围" data-tid="singleRange" class="singleRange">
        <el-radio
          v-model="ruleForm.singleRange"
          :label="1"
          class="content-radio-man"
          data-tid="content-radio-man"
          >本商户内</el-radio
        >
        <el-radio v-model="ruleForm.singleRange" :label="2" data-tid="content-radio-woman"
          >薯片平台</el-radio
        >
      </el-form-item>
      <!-- 合作原因行！ -->
      <el-form-item label="合作原因：" data-tid="workingReason">
        <el-input
          v-model="ruleForm.workingReason"
          v-emoji="'textarea'"
          type="textarea"
