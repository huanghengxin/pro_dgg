...
import BusinessDemandInfo from './components/business-demand-info/index.vue';
import BusinessRole from './components/business-role/index.vue';
import { getQueryString } from 'utils/helper';
import { get_menu_permission } from 'api/source-details';
export default {
